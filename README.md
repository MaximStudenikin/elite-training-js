...
| [Task 5](https://github.com/MaximStudenikin/elite-training-js/tree/task-5) | ```$ git clone https://github.com/MaximStudenikin/elite-training-js.git -b task-5 ``` |
| [Task 6](https://github.com/MaximStudenikin/elite-training-js/tree/task-6) | ```$ git clone https://github.com/MaximStudenikin/elite-training-js.git -b task-6 ``` |
| [Task 7](https://github.com/MaximStudenikin/elite-training-js/tree/task-7) | ```$ git clone https://github.com/MaximStudenikin/elite-training-js.git -b task-7 ``` |